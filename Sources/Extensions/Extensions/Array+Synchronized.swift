...
//  STPhotoMap-iOS
//
//  Created by Crasneanu Cristian on 15/04/2019.
...
public class SynchronizedArray<Element> {
    fileprivate let queue = DispatchQueue(label: "com.streetography.st.photo.map.ios.STPhotoMap.SynchronizedArray", attributes: .concurrent)
